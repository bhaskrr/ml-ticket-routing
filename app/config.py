...
class Settings:
    ...
    CATEGORY_CLASSIFIER_MODEL_PATH: str = os.path.join(BASE_DIR, "ml/models/category_classifier.gzip")
    CATEGORY_CLASSIFIER_VECTORIZER_PATH: str = os.path.join(BASE_DIR, "ml/vectorizers/category_classifier/vectorizer.joblib")
    PRIORITY_CLASSIFIER_MODEL_PATH: str = os.path.join(BASE_DIR, "ml/models/priority_classifier.gzip")
